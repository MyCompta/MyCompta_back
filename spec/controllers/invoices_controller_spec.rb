...
RSpec.describe InvoicesController, type: :controller do
  ...
  describe 'GET #show' do
    it 'returns http success and invoice data with author and client info' do
      ...
      expect(response).to have_http_status(:success)
      expect(response.parsed_body['invoice']['content']).to eq(invoice.content)
      expect(response.parsed_body['author']['name']).to eq(society.name)
      expect(response.parsed_body['client']['first_name']).to eq(client.first_name)
    end
  end
